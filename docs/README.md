...
This documentation set is organized around runtime behavior, component contracts, and integration policy.

## Reading Order

1. `docs/overview.md`
2. `docs/build.md`
3. `docs/architecture/event-pipeline.md`
4. `docs/architecture/rendering-backend.md`
